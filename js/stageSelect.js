...
import { SCREEN_WIDTH, CANVAS_HEIGHT, STAGES, getUiScale, getFontScale, getScreenSafeArea, isTouchOverlayMode } from './constants.js?v=screen-safe-20260919a';
import { fillTextInkCentered, drawScreenManualLine, formatCount } from './ui.js?v=screen-safe-20260919a';
import { getSideBest } from './sideStageCommon.js?v=screen-safe-20260919a';
