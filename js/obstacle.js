...
import { OBSTACLE_TYPES, OBSTACLE_SETTINGS, LANE_OFFSET } from './constants.js?v=screen-safe-20260920e';
import { audio } from './audio.js?v=screen-safe-20260920e';
import { drawImageGraded } from './filteredImage.js?v=screen-safe-20260920e';
import { getImage } from './imageCache.js?v=screen-safe-20260920e';
...
const ROCK_VISUAL_PALETTES = {
    slab: {
        ...
        outline: '25, 26, 27',
        crack: '23, 24, 25',
        crackLight: '109, 106, 103',
        dust: '72, 72, 73',
        ring: '66, 67, 68',
        shards: ['56, 58, 60', '76, 76, 77', '96, 94, 91', '103, 100, 97']
    },
    tall: {
        light: '94, 91, 85',
        mid: '75, 75, 75',
        ...
        outline: '22, 23, 25',
        crack: '20, 21, 23',
        crackLight: '100, 96, 90',
        dust: '66, 67, 68',
        ring: '60, 61, 62',
        shards: ['47, 50, 54', '62, 63, 64', '75, 75, 75', '94, 91, 85']
    },
    jagged: {
        light: '93, 90, 87',
        mid: '78, 75, 74',
        ...
        dust: '66, 64, 65',
        ring: '60, 59, 61',
        shards: ['47, 48, 51', '61, 60, 62', '78, 75, 74', '93, 90, 87']
    }
};
...
export class Obstacle {
    ...
    /**
     * 一撃で砕く。大薙(X攻撃ブースト)のような「巨大な光刃」で斬ったときに使う。
     * takeDamage の hitTimer(連打の無効時間)も残りHPも見ずに落とす — 光刃が岩に
     * 三度も引っかかる絵にしないため。
     */
    shatter() {
