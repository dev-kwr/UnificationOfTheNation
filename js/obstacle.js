...
import { OBSTACLE_TYPES, OBSTACLE_SETTINGS, LANE_OFFSET } from './constants.js?v=screen-safe-20260919d';
import { audio } from './audio.js?v=screen-safe-20260919d';
import { drawImageGraded } from './filteredImage.js?v=screen-safe-20260919d';
import { getImage } from './imageCache.js?v=screen-safe-20260919d';
