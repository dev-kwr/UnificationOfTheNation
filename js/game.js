...
import { CANVAS_WIDTH, SCREEN_WIDTH, CANVAS_HEIGHT, GAME_STATE, STAGES, DIFFICULTY, OBSTACLE_TYPES, PLAYER, STAGE_DEFAULT_WEAPON, LANE_OFFSET, STAGE6_CORNER, UI_SIZE_ANCHOR, getDeviceProfile, setUiScaleFromFitScale, setCornerInsets, setNotchInsetX, setVirtualPadVisible } from './constants.js?v=screen-safe-20260809d';
import { BOSS_STAGING } from './bossStaging.js?v=screen-safe-20260809d';
import { isUpdateAvailable, applyUpdate } from './appUpdate.js?v=screen-safe-20260809d';
...
import { Player } from './player.js?v=screen-safe-20260809d';
import { createSubWeapon } from './weapon.js?v=screen-safe-20260809d';
import { Stage, preloadStageImages, prefetchStageImages, areStageImagesSettled } from './stage.js?v=screen-safe-20260809d';
import { GRAPPLE_PHASE } from './stage6Grapple.js?v=screen-safe-20260809d';
import { UI, renderTitleScreen, renderTitleDebugWindow, renderGameOverScreen, renderStatusScreen, renderStageClearAnnouncement, renderLevelUpChoiceScreen, renderPauseScreen, getPauseReturnButton, renderGameClearScreen, renderIntro, renderEnding, getTitleScreenLayout, getStatusScreenLayout, getTitleDebugLayout, renderBossNameBanner } from './ui.js?v=screen-safe-20260809d';
import { CollisionManager, checkPlayerEnemyCollision, checkEnemyAttackHit } from './collision.js?v=screen-safe-20260809d';
import { saveManager } from './save.js?v=screen-safe-20260809d';
import { shop } from './shop.js?v=screen-safe-20260809d';
import { audio } from './audio.js?v=screen-safe-20260809d';
import { ShadowRenderer } from './shadow.js?v=screen-safe-20260809d';
import { applyShogunCombat } from './shogunCombatHelper.js?v=screen-safe-20260809d';
import { getRockVisualPalette } from './obstacle.js?v=screen-safe-20260809d';
...
class Game {
    ...
    continueGame(saveData) {
        ...
        // 武器作成関数をインポート
        import('./weapon.js?v=screen-safe-20260809d').then(module => {
            // 基本ステータス復元
