...
import { CANVAS_WIDTH, SCREEN_WIDTH, CANVAS_HEIGHT, GAME_STATE, STAGES, DIFFICULTY, OBSTACLE_TYPES, PLAYER, STAGE_DEFAULT_WEAPON, LANE_OFFSET, STAGE5_FLOOR, STAGE6_CORNER, UI_SIZE_ANCHOR, getDeviceProfile, setUiScaleFromFitScale, setCornerInsets, setNotchInsetX, setVirtualPadVisible, setBgmButtonVisible, isTouchOverlayMode } from './constants.js?v=screen-safe-20260817j';
import { BOSS_STAGING } from './bossStaging.js?v=screen-safe-20260817j';
import { isUpdateAvailable, applyUpdate, checkForUpdate } from './appUpdate.js?v=screen-safe-20260817j';
import { getStageSelectLayout, renderStageSelect, STAGE_SELECT_ORDER } from './stageSelect.js?v=screen-safe-20260817j';
import { clearFilteredImageCache, getFilteredImageCacheStats } from './filteredImage.js?v=screen-safe-20260817j';
import { BonusStage, BONUS_STAGE_IMAGES } from './bonusStage.js?v=screen-safe-20260817j';
import { TrainingStage, TRAINING_STAGE_IMAGES } from './trainingStage.js?v=screen-safe-20260817j';
import { sideBestKey, normalizeSideBests, getSideBest } from './sideStageCommon.js?v=screen-safe-20260817j';
import { preloadImages, areImagesSettled } from './imageCache.js?v=screen-safe-20260817j';
import { readPhysicalScreen, computeScreenWidth } from './screenGeometry.js?v=screen-safe-20260817j';
import { input } from './input.js?v=screen-safe-20260817j';
...
import { Player } from './player.js?v=screen-safe-20260817j';
import { createSubWeapon } from './weapon.js?v=screen-safe-20260817j';
import { Stage, preloadStageImages, prefetchStageImages, areStageImagesSettled } from './stage.js?v=screen-safe-20260817j';
import { GRAPPLE_PHASE } from './stage6Grapple.js?v=screen-safe-20260817j';
import { UI, renderTitleScreen, renderTitleDebugWindow, renderGameOverScreen, renderStatusScreen, renderStageClearAnnouncement, renderLevelUpChoiceScreen, getLevelUpChoiceLayout, renderSideResultScreen, getSideResultLayout, renderPauseScreen, getPauseReturnButton, getPauseMapButton, renderGameClearScreen, renderIntro, renderEnding, getTitleScreenLayout, getStatusScreenLayout, getTitleDebugLayout, getUpdateModalLayout, renderBossNameBanner, getBossNameBannerBox } from './ui.js?v=screen-safe-20260817j';
import { CollisionManager, checkPlayerEnemyCollision, checkEnemyAttackHit } from './collision.js?v=screen-safe-20260817j';
import { saveManager } from './save.js?v=screen-safe-20260817j';
import { shop } from './shop.js?v=screen-safe-20260817j';
import { audio } from './audio.js?v=screen-safe-20260817j';
import { ShadowRenderer } from './shadow.js?v=screen-safe-20260817j';
import { applyShogunCombat } from './shogunCombatHelper.js?v=screen-safe-20260817j';
import { getRockVisualPalette } from './obstacle.js?v=screen-safe-20260817j';
...
class Game {
    ...
    continueGame(saveData) {
        ...
        // 武器作成関数をインポート
        import('./weapon.js?v=screen-safe-20260817j').then(module => {
            // 基本ステータス復元
