...
import { CANVAS_WIDTH, SCREEN_WIDTH, CANVAS_HEIGHT, GAME_STATE, STAGES, DIFFICULTY, OBSTACLE_TYPES, PLAYER, STAGE_DEFAULT_WEAPON, LANE_OFFSET, STAGE6_CORNER, UI_SIZE_ANCHOR, getDeviceProfile, setUiScaleFromFitScale, setCornerInsets, setNotchInsetX, setVirtualPadVisible, setBgmButtonVisible, isTouchOverlayMode } from './constants.js?v=screen-safe-20260811m';
import { BOSS_STAGING } from './bossStaging.js?v=screen-safe-20260811m';
import { isUpdateAvailable, applyUpdate, checkForUpdate } from './appUpdate.js?v=screen-safe-20260811m';
import { getStageSelectLayout, renderStageSelect, STAGE_SELECT_ORDER } from './stageSelect.js?v=screen-safe-20260811m';
import { BonusStage, BONUS_STAGE_IMAGES } from './bonusStage.js?v=screen-safe-20260811m';
import { TrainingStage, TRAINING_STAGE_IMAGES } from './trainingStage.js?v=screen-safe-20260811m';
import { sideBestKey, normalizeSideBests, getSideBest } from './sideStageCommon.js?v=screen-safe-20260811m';
import { preloadImages, areImagesSettled } from './imageCache.js?v=screen-safe-20260811m';
import { readPhysicalScreen, computeScreenWidth } from './screenGeometry.js?v=screen-safe-20260811m';
import { input } from './input.js?v=screen-safe-20260811m';
...
import { Player } from './player.js?v=screen-safe-20260811m';
import { createSubWeapon } from './weapon.js?v=screen-safe-20260811m';
import { Stage, preloadStageImages, prefetchStageImages, areStageImagesSettled } from './stage.js?v=screen-safe-20260811m';
import { GRAPPLE_PHASE } from './stage6Grapple.js?v=screen-safe-20260811m';
import { UI, renderTitleScreen, renderTitleDebugWindow, renderGameOverScreen, renderStatusScreen, renderStageClearAnnouncement, renderLevelUpChoiceScreen, getLevelUpChoiceLayout, renderSideResultScreen, getSideResultLayout, renderPauseScreen, getPauseReturnButton, renderGameClearScreen, renderIntro, renderEnding, getTitleScreenLayout, getStatusScreenLayout, getTitleDebugLayout, getUpdateModalLayout, renderBossNameBanner } from './ui.js?v=screen-safe-20260811m';
import { CollisionManager, checkPlayerEnemyCollision, checkEnemyAttackHit } from './collision.js?v=screen-safe-20260811m';
import { saveManager } from './save.js?v=screen-safe-20260811m';
import { shop } from './shop.js?v=screen-safe-20260811m';
import { audio } from './audio.js?v=screen-safe-20260811m';
import { ShadowRenderer } from './shadow.js?v=screen-safe-20260811m';
import { applyShogunCombat } from './shogunCombatHelper.js?v=screen-safe-20260811m';
import { getRockVisualPalette } from './obstacle.js?v=screen-safe-20260811m';
...
class Game {
    ...
    continueGame(saveData) {
        ...
        // 武器作成関数をインポート
        import('./weapon.js?v=screen-safe-20260811m').then(module => {
            // 基本ステータス復元
