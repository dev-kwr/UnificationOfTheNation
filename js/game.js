...
import { CANVAS_WIDTH, SCREEN_WIDTH, CANVAS_HEIGHT, GAME_STATE, STAGES, DIFFICULTY, OBSTACLE_TYPES, PLAYER, STAGE_DEFAULT_WEAPON, LANE_OFFSET, STAGE5_FLOOR, STAGE6_CORNER, UI_SIZE_ANCHOR, getDeviceProfile, setUiScaleFromFitScale, setCornerInsets, setNotchInsetX, setVirtualPadVisible, setBgmButtonVisible, isTouchOverlayMode } from './constants.js?v=screen-safe-20260815h';
import { BOSS_STAGING } from './bossStaging.js?v=screen-safe-20260815h';
import { isUpdateAvailable, applyUpdate, checkForUpdate } from './appUpdate.js?v=screen-safe-20260815h';
import { getStageSelectLayout, renderStageSelect, STAGE_SELECT_ORDER } from './stageSelect.js?v=screen-safe-20260815h';
import { clearFilteredImageCache, getFilteredImageCacheStats } from './filteredImage.js?v=screen-safe-20260815h';
import { BonusStage, BONUS_STAGE_IMAGES } from './bonusStage.js?v=screen-safe-20260815h';
import { TrainingStage, TRAINING_STAGE_IMAGES } from './trainingStage.js?v=screen-safe-20260815h';
import { sideBestKey, normalizeSideBests, getSideBest } from './sideStageCommon.js?v=screen-safe-20260815h';
import { preloadImages, areImagesSettled } from './imageCache.js?v=screen-safe-20260815h';
import { readPhysicalScreen, computeScreenWidth } from './screenGeometry.js?v=screen-safe-20260815h';
import { input } from './input.js?v=screen-safe-20260815h';
...
import { Stage, preloadStageImages, prefetchStageImages, areStageImagesSettled } from './stage.js?v=screen-safe-20260815h';
import { GRAPPLE_PHASE } from './stage6Grapple.js?v=screen-safe-20260815h';
import { UI, renderTitleScreen, renderTitleDebugWindow, renderGameOverScreen, renderStatusScreen, renderStageClearAnnouncement, renderLevelUpChoiceScreen, getLevelUpChoiceLayout, renderSideResultScreen, getSideResultLayout, renderPauseScreen, getPauseReturnButton, getPauseMapButton, renderGameClearScreen, renderIntro, renderEnding, getTitleScreenLayout, getStatusScreenLayout, getTitleDebugLayout, getUpdateModalLayout, renderBossNameBanner, getBossNameBannerBox } from './ui.js?v=screen-safe-20260815h';
import { CollisionManager, checkPlayerEnemyCollision, checkEnemyAttackHit } from './collision.js?v=screen-safe-20260815h';
import { saveManager } from './save.js?v=screen-safe-20260815h';
import { shop } from './shop.js?v=screen-safe-20260815h';
import { audio } from './audio.js?v=screen-safe-20260815h';
import { ShadowRenderer } from './shadow.js?v=screen-safe-20260815h';
import { applyShogunCombat } from './shogunCombatHelper.js?v=screen-safe-20260815h';
import { getRockVisualPalette } from './obstacle.js?v=screen-safe-20260815h';
...
class Game {
    ...
    continueGame(saveData) {
        ...
        // 武器作成関数をインポート
        import('./weapon.js?v=screen-safe-20260815h').then(module => {
            // 基本ステータス復元
    ...
    updateStage5FloorTransition() {
        ...
        if (prevPhase === 1 && currentPhase === 2) {
            ...
            const playerWidth = this.player.getWorldWidth();
            // 【着地点は降り口の穴の外(床の上)】。旧値は端から100px＝穴(幅200)の
            // ど真ん中で、階段室の空中に立って現れていた。穴の中身が見える絵に
            // なってから「配置がおかしい」の正体はこれ(実機フィードバック 2026-08-15)。
            // 框を越えたすぐの床に立たせる＝階段を登り切って一歩踏み出した位置。
            const holeW = (STAGE5_FLOOR.PREVIOUS_STAIR_VISIBLE_WIDTH || 200);
            const stepOff = holeW + 26;
            this.player.x = isRightDir
                ? stepOff
                : this.stage.maxProgress - stepOff - playerWidth;
