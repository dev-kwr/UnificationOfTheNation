...
import { Player } from './player.js?v=screen-safe-20260809f';
import { createSubWeapon } from './weapon.js?v=screen-safe-20260809f';
import { Stage, preloadStageImages, prefetchStageImages, areStageImagesSettled } from './stage.js?v=screen-safe-20260809f';
import { GRAPPLE_PHASE } from './stage6Grapple.js?v=screen-safe-20260809f';
import { UI, renderTitleScreen, renderTitleDebugWindow, renderGameOverScreen, renderStatusScreen, renderStageClearAnnouncement, renderLevelUpChoiceScreen, renderPauseScreen, getPauseReturnButton, renderGameClearScreen, renderIntro, renderEnding, getTitleScreenLayout, getStatusScreenLayout, getTitleDebugLayout, renderBossNameBanner } from './ui.js?v=screen-safe-20260809f';
import { CollisionManager, checkPlayerEnemyCollision, checkEnemyAttackHit } from './collision.js?v=screen-safe-20260809f';
import { saveManager } from './save.js?v=screen-safe-20260809f';
import { shop } from './shop.js?v=screen-safe-20260809f';
import { audio } from './audio.js?v=screen-safe-20260809f';
import { ShadowRenderer } from './shadow.js?v=screen-safe-20260809f';
import { applyShogunCombat } from './shogunCombatHelper.js?v=screen-safe-20260809f';
import { getRockVisualPalette } from './obstacle.js?v=screen-safe-20260809f';
...
class Game {
    ...
    continueGame(saveData) {
        ...
        // 武器作成関数をインポート
        import('./weapon.js?v=screen-safe-20260809f').then(module => {
            // 基本ステータス復元
