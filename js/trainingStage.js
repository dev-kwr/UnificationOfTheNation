...
import { CANVAS_WIDTH, CANVAS_HEIGHT, LANE_OFFSET, ENEMY_TYPES } from './constants.js?v=screen-safe-20260820b';
import { createEnemy } from './enemy.js?v=screen-safe-20260820b';
import { getImage } from './imageCache.js?v=screen-safe-20260820b';
import { pushGain, updateGainPops, renderGainPops, tickTimeLimit, clampToLeftEdge } from './sideStageCommon.js?v=screen-safe-20260820b';
