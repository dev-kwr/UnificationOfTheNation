...
import { STAGE6_CORNER } from './constants.js?v=screen-safe-20260919d';
import { Kusarigama } from './weapon.js?v=screen-safe-20260919d';
import {
    chainCurve, sampleQuad, drawChain,
    pushTrailPoint, drawCometRibbon,
    makeParticles, drawSparks, drawBlastFlash,
    smoothstep01
} from './weaponFx.js?v=screen-safe-20260919d';
