...
// 最高記録（難易度別）
// ============================================
// 道場: 敵の体力が易0.8倍〜難1.8倍と幅があり、討伐数を同じ土俵で比べられない。
// 蔵: 敵は居ないので体力倍率は届かない。代わりに塔の段差・吊り棚の振れ幅と速さ・
//     小判の値打ちが難易度で変わる(bonusStage.js の BONUS_DIFFICULTY)。
// どちらも土俵が違うので、記録は `${kind}_${difficultyId}` で分けて持つ。
