...
import { translateRibbonChains, resetRibbonChains } from './mobFx.js?v=screen-safe-20260819a';
import { CLOTH_CHAIN, HEADBAND_TAIL_SPEC, stepClothSwing, stepClothNode } from './clothChain.js?v=screen-safe-20260819a';
import { applyRendererMixin }    from './playerRenderer.js?v=screen-safe-20260819a';
import { applySlashTrailMixin }  from './playerSlashTrail.js?v=screen-safe-20260819a';
import { applySpecialMixin }     from './playerSpecial.js?v=screen-safe-20260819a';
