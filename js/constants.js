...
export const STAGE6_CORNER = {
    ...
    EAVE_JUMP_ZONE_PX: 360,         // 角3: 行き止まり手前の「軒へ鉤縄を掛ける」受付帯の幅
    EAVE_REACH_HEIGHT: 80,          // 足元が床からこの高さを超えたら軒へ手を伸ばせたとみなす
    // 角3の登攀演出(鉤縄で頭上の軒へ):
    // 廻縁の突き当たりでジャンプ→鉤縄が軒の垂木に掛かる→引き上げられて屋根の上へ。
    // 忍者の身体能力の範囲で、建築的な嘘(廻縁から屋根への階段など)を作らない導線。
    GRAPPLE_ROPE_MS: 260,           // 鉤縄が伸びて軒に掛かるまで
    GRAPPLE_PULL_MS: 420,           // 引き上げられて画面上へ消えるまで
    EAVE_WORLD_Y: 150,              // 軒(鉤縄が掛かる先)の画面y。壁の上部意匠に載る高さ
