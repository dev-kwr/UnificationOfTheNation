...
import { CANVAS_WIDTH, CANVAS_HEIGHT, LANE_OFFSET } from './constants.js?v=screen-safe-20260815c';
import { audio } from './audio.js?v=screen-safe-20260815c';
import { getImage } from './imageCache.js?v=screen-safe-20260815c';
import { drawKobanImage } from './ui.js?v=screen-safe-20260815c';
import { pushGain, updateGainPops, renderGainPops, tickTimeLimit, clampToLeftEdge } from './sideStageCommon.js?v=screen-safe-20260815c';
