...
import { CANVAS_WIDTH, CANVAS_HEIGHT, LANE_OFFSET } from './constants.js?v=screen-safe-20260817y';
import { audio } from './audio.js?v=screen-safe-20260817y';
import { getImage } from './imageCache.js?v=screen-safe-20260817y';
import { drawKobanImage } from './ui.js?v=screen-safe-20260817y';
import { pushGain, updateGainPops, renderGainPops, tickTimeLimit, clampToLeftEdge } from './sideStageCommon.js?v=screen-safe-20260817y';
