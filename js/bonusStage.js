...
import { CANVAS_WIDTH, CANVAS_HEIGHT, LANE_OFFSET } from './constants.js?v=screen-safe-20260919b';
import { audio } from './audio.js?v=screen-safe-20260919b';
import { getImage } from './imageCache.js?v=screen-safe-20260919b';
import { drawKobanImage } from './ui.js?v=screen-safe-20260919b';
import { pushGain, updateGainPops, renderGainPops, tickTimeLimit, clampToLeftEdge } from './sideStageCommon.js?v=screen-safe-20260919b';
