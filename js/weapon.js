...
import { GRAVITY, CANVAS_WIDTH, LANE_OFFSET, PLAYER } from './constants.js?v=screen-safe-20260810a';
import { audio } from './audio.js?v=screen-safe-20260810a';
import { SHOGUN_SCALE } from './shogunConstants.js?v=screen-safe-20260810a';
import { withDropShadow, drawSparks, drawBlastFlash, makeParticles, smoothstep01, pushTrailPoint, drawCometRibbon } from './weaponFx.js?v=screen-safe-20260810a';
